<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listado.aspx.cs" Inherits="Asistencia.Presentacion.RegistroAsistencia.Listado"
MasterPageFile="~/Adm.Master" StylesheetTheme="Default"%>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Label ID="Label2" runat="server" Text="Listado de Asistencia"></asp:Label>
    ...
    <asp:GridView ID="gvListado" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="hora" DataFormatString="{0:dd/MMMM/yyyy}" 
                HeaderText="Fecha">
